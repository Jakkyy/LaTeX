...
\begin{document}
    ...
    \[ S^2 := \frac{1}{n-1} \sum_{i}^{} (X_i - \overline{X})^2 \longrightarrow \boldsymbol{\frac{\overline{X} - \mu}{\frac{S}{\sqrt{n}}} \sim t_{n-1}}\]
    ...
    \[ S \approx 3.082 \]
    Dato che la nostra è una var. aleatoria di tipo t dobbiamo ricorrere alla sua tabella, troviamo che il valore $t_{0.025,8} \approx 2.306$, quindi un intervallo di confidenza al 95\% per $\mu$ è dato da:
